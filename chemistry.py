# chemistry.py
# Programa para calcular massa molar e número de mols de um composto químico
# Utiliza a biblioteca formula.py para interpretar fórmulas químicas

from formula import parse_formula

def make_periodic_table():
    """Retorna um dicionário com todos os elementos da tabela periódica.
    A chave é o símbolo do elemento, o valor é uma lista [nome, massa_atômica].
    """
    periodic_table_dict = {
        "Ac": ["Actinium", 227],
        "Ag": ["Silver", 107.8682],
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    """Calcula a massa molar do composto químico."""
    total_mass = 0.0
